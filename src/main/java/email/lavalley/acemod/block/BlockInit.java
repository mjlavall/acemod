package email.lavalley.acemod.block;
...
public class BlockInit {
    ...
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(ForgeRegistries.BLOCKS, AceModMain.MODID);

    public static final RegistryObject<Block> DORITOS_BOX = BLOCKS.register("doritos_box",
