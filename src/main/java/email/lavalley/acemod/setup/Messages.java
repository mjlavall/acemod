...
// import email.lavalley.acemod.manasystem.network.PacketGatherMana;
// import email.lavalley.acemod.manasystem.network.PacketSyncManaToClient;
...
public class Messages {
    ...
    public static void register() {
        SimpleChannel net = NetworkRegistry.ChannelBuilder
                .named(new ResourceLocation(AceModMain.MODID, "messages"))
